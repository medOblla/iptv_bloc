                          ...
                          child: ChannelCard(
                              ...
                              onTap: () {
                                Navigator.push(context,
                                  ...
                                  return Player(
                                      video_url: "https://cdn.jmvstream.com/w/LVW-8155/ngrp:LVW8155_41E1ciuCvO_all/playlist.m3u8");
                                }));
                              },
                              ...
                              model: ChannelCardModel(
                                  channel_category: widget
                                      ...
                                      ? widget
                                          .models[index].categories![0]
                                      : "Entertainment",
                                  channel_name: widget.models[index].name!,
                                  code: widget
                                          .models[index].country!.isEmpty
                                      ? widget.models[index].country!
                                      : "International",
                                  ...
                                  languages: widget
                                      ...
                                      ? widget.models[index].languages![0]
                                      : "None")),
                        ),
                      ),
                    );
